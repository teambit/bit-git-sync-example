...
import { APISchema, ExportSchema, ModuleSchema } from '@teambit/semantics.entities.semantic-schema';
...
export class APIReferenceModel {
  ...
  mapToAPINode(api: APISchema, renderers: APINodeRenderer[], componentId: ComponentID): APINode[] {
    ...
    exportedSchemaNodes.forEach((exportedNode) => {
      if (ModuleSchema.isModuleSchema(exportedNode)) {
        exportedSchemaNodes.push(...exportedNode.exports);
